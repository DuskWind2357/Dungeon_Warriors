...
# ================================================================
SNOW_ELITE_MONSTERS = [
    {"name": "冰霜僵尸",   "hp": 50, "atk": 6,  "range": 1.5, "cd": 1.2, "speed": 1.5, "detect": 500, "color": "blue_light", "ranged": False, "frost": 4.0},
    {"name": "流髑",       "hp": 50, "atk": 8,  "range": 1.5, "cd": 2.0, "speed": 2.5, "detect": 500, "color": "gray_white", "ranged": True,  "frost": 3.0},
]
...
MONSTER_BASE_STATS = {
    "normal": {"hp": 30, "attack": 5, "attack_range": 1.5, "attack_cooldown": 0.5},
    "elite":  {"hp": 50, "attack": 7, "attack_range": 2.0, "attack_cooldown": 0.8},
}
